...
Clads_clades = ["Aizoaceae_Phytolaccaceae_Barbeuiaceae_Lophiocarpaceae_Gisekiaceae_Sarcobataceae",
                ...
                "Calyceraceae",
                "Campanulaceae_Rousseaceae","Cannabaceae",
                "Capparaceae",
                ...
                "Ebenaceae",
                #"Ericaceae_Clethraceae_Cyrillaceae",
                "Gentianaceae",
                "Goodeniaceae",
                "Heliconiaceae_Lowiaceae_Strelitziaceae",
                "Juncaceae",
                "Loganiaceae_Gelsemiaceae",
                "Lythraceae_Onagraceae",
                "Malvaceae",
                "Marantaceae_Cannaceae",
                "Meliaceae",
                "Menispermaceae",
                "Menyanthaceae",
                "Monimiaceae",
                ...
                #"Orobanchaceae_Phrymaceae_Mazaceae_Paulowniaceae",
                #"Papaveraceae",
                "Passifloraceae",
                "Pentaphylacaceae_Sladeniaceae",
                "Pittosporaceae",
                #"Plumbaginaceae_Polygonaceae_Frankeniaceae_Tamaricaceae",
                ...
                "Convolvulaceae",
                "Cucurbitaceae",
                "Begoniaceae_Corynocarpaceae_Datiscaceae_Tetramelaceae_Coriariaceae"]
...
for i in range(len(Clads_clades)):
    ...
    for j in range(len(percentages)):
        gwf.target_from_template(name = Clads_clades[i]+"_states_converter_"+percentages[j],
                                template=states_converter(
                                path_in= workflow_dir+"03_distribution_data/",
                                tip_states_file= workflow_dir+"03_distribution_data/"+Clads_clades[i]+"_distribution_data_ClaDs.txt",
 ...
 #Running the script to find the environmental data for the tips in the sub trees
    ...
    for j in range(len(percentages)):
        gwf.target_from_template(name = sub_family_clades[k]+"_states_converter_"+percentages[j],
                                template=states_converter(
                                path_in= workflow_dir+"03_distribution_data/",
                                tip_states_file= workflow_dir+"03_distribution_data/"+sub_family_clades[k]+"_distribution_data_ClaDs.txt",
...
###############################################################################################################################################################
# Orders that ran with the uniform prior 
orders_not_in_orders_new_prior = [
                                  #"Arecales",
                                  "Buxales",
                                  "Canellales",
                                  "Celastrales",
...
for i in range(len(orders_not_in_orders_new_prior)):
            ...
            for j in range(len(percentages)):
                ...
                for k in range(5):
                    gwf.target_from_template(name = orders_not_in_orders_new_prior[i]+"_"+str(k)+"_Esse_G",
                                                template = Esse(
                                                tree_file = orders_not_in_orders_new_prior[i]+"_Esse_tree.tre", # Input tree
                                                tip_states_file = workflow_dir+"03_distribution_data/"+orders_not_in_orders_new_prior[i]+"_states_"+percentages[j]+"_Esse.txt", 
                                                paleo_clim_file = "NaN", # File with paleoclimatic variables
                                                done = orders_not_in_orders_new_prior[i]+"_"+str(k)+"_Esse_G",
                                                path_in = workflow_dir+"02_adding_orders/pruning/orders/",
                                                save_file = "Esse_output_G_"+orders_not_in_orders_new_prior[i]+"_"+percentages[j]+"_"+str(k)+".jld2",
                                                script_dir=script_dir,
                                                done_dir = done_dir,
                                                out_states_file = "Esse_states_G_"+orders_not_in_orders_new_prior[i]+"_"+percentages[j]+"_"+str(k), 
                                                hidden_states = 1,
                                                niter= 200000,
                                                out_file = "Esse_output_G_"+orders_not_in_orders_new_prior[i]+"_hidden_states_"+percentages[j]+"_"+str(k),
                                                output_folder = workflow_dir+"04_results/Esse_output/",
                                                path_out = workflow_dir+"04_results/",
                                                biome_sampling= workflow_dir+"03_distribution_data/"+orders[i]+"_biome_sampling_fraction.txt"
                                            ))
...
for i in range(len(orders_shorter)):
            gwf.target_from_template(name = orders_shorter[i]+"_distribution_data_Esse",
                                ...
                                path_in =  workflow_dir+"02_adding_orders/pruning/orders/",
                                path_out = workflow_dir+"03_distribution_data/",
                                output_file = orders_shorter[i]+"_distribution_data_Esse.txt",
                                wcvp_file = workflow_dir+"02_adding_orders/wcvp_names_apg_aligned.rds",
            ...
            for j in range(len(percentages)):
                    gwf.target_from_template(name = orders_shorter[i]+"_states_converter_Esse_"+percentages[j],
                                            template=states_converter(
                                            path_in= workflow_dir+"03_distribution_data/",
                                            tip_states_file= workflow_dir+"03_distribution_data/"+orders_shorter[i]+"_distribution_data_Esse.txt",
                    ...
                    gwf.target_from_template(name = orders_shorter[i]+"_Sampling_fraction_Esse",
                                         template = sampling_frequency(
                                                ...
                                                path_in =  workflow_dir+"02_adding_orders/pruning/orders/",
                                                path_out = workflow_dir+"03_distribution_data/",
                                                output_file = orders_shorter[i]+"_sampling_fraction_Esse.txt",
                                                wcvp_file = workflow_dir+"02_adding_orders/wcvp_names_apg_aligned.rds",
                                                order = orders_shorter[i],
                                                script_dir= script_dir,
                                                apg = script_dir+"apgweb_parsed.csv",
                    ...
                    for k in range(10):
                        gwf.target_from_template(name = orders_shorter[i]+"_"+str(k)+"_Esse_G",
                                                template = Esse(
                                                tree_file = orders_shorter[i]+"_Esse_tree.tre", # Input tree
                                                tip_states_file = workflow_dir+"03_distribution_data/"+orders_shorter[i]+"_states_"+percentages[j]+"_Esse.txt", 
                                                paleo_clim_file = "NaN", # File with paleoclimatic variables
                                                done = orders_shorter[i]+"_"+str(k)+"_Esse_G",
                                                path_in = workflow_dir+"02_adding_orders/pruning/orders/",
                                                save_file = "Esse_output_G_"+orders_shorter[i]+"_"+percentages[j]+"_"+str(k)+".jld2",
                                                script_dir=script_dir,
                                                done_dir = done_dir,
                                                out_states_file = "Esse_states_G_"+orders_shorter[i]+"_"+percentages[j]+"_"+str(k), 
                                                hidden_states = 1,
                                                niter = 100000,
                                                out_file = "Esse_output_G_"+orders_shorter[i]+"_hidden_states_"+percentages[j]+"_"+str(k),
                                                output_folder = workflow_dir+"04_results/Esse_output/",
                                                path_out = workflow_dir+"04_results/",
                                                biome_sampling = workflow_dir+"03_distribution_data/"+orders_shorter[i]+"_biome_sampling_fraction.txt"
                                             ))
...
for i in range(len(esse_clades)):
                ...
                for j in range(len(percentages)):
                    gwf.target_from_template(name = esse_clades[i]+"_states_converter_Esse_"+percentages[j],
                                            template=states_converter(
                                            path_in= workflow_dir+"03_distribution_data/",
                                            tip_states_file= workflow_dir+"03_distribution_data/"+esse_clades[i]+"_distribution_data_Esse.txt",
                    ...
                    for k in range(5):
                        gwf.target_from_template(name = esse_clades[i]+"_"+str(k)+"_Esse",
                                                    ...
                                                    path_in = workflow_dir+"02_adding_orders/pruning/subset_of_orders/",
                                                    save_file = "Esse_output_"+esse_clades[i]+"_"+percentages[j]+"_"+str(k)+".jld2",
                                                    script_dir=script_dir,
                                                    done_dir = done_dir,
                                                    out_states_file = "Esse_states_"+esse_clades[i]+"_"+percentages[j]+"_"+str(k), 
                                                    hidden_states = 1,
                                                    niter = 200000,
                                                    out_file = "Esse_output_"+esse_clades[i]+"_hidden_states_"+percentages[j]+"_"+str(k),
                                                    output_folder = workflow_dir+"04_results/Esse_output/",
                                                    path_out = workflow_dir+"04_results/",
                                                    biome_sampling = workflow_dir+"03_distribution_data/"+esse_clades[i]+"_biome_sampling_fraction.txt"
                                                 ))
                    for k in range(5):
                        gwf.target_from_template(name = esse_clades[i]+"_"+str(k)+"_Esse_G",
                                                    template = Esse(
                                                    tree_file = esse_clades[i]+"_Esse_tree.tre", # Input tree
                                                    tip_states_file = workflow_dir+"03_distribution_data/"+esse_clades[i]+"_states_"+percentages[j]+"_Esse.txt", 
                                                    paleo_clim_file = "NaN", # File with paleoclimatic variables
                                                    done = esse_clades[i]+"_"+str(k)+"_Esse_G",
                                                    path_in = workflow_dir+"02_adding_orders/pruning/subset_of_orders/",
                                                    save_file = "Esse_output_G_"+esse_clades[i]+"_"+percentages[j]+"_"+str(k)+".jld2",
                                                    script_dir=script_dir,
                                                    done_dir = done_dir,
                                                    out_states_file = "Esse_states_G_"+esse_clades[i]+"_"+percentages[j]+"_"+str(k), 
                                                    hidden_states = 1,
                                                    niter = 200000,
                                                    out_file = "Esse_output_G_"+esse_clades[i]+"_hidden_states_"+percentages[j]+"_"+str(k),
                                                    output_folder = workflow_dir+"04_results/Esse_output/",
                                                    path_out = workflow_dir+"04_results/",
                                                    biome_sampling = workflow_dir+"03_distribution_data/"+esse_clades[i]+"_biome_sampling_fraction.txt"
                                                 ))
...
for i in range(len(families_shorter)):
            ...
            for j in range(len(percentages)):
                    gwf.target_from_template(name = families_shorter[i]+"_states_converter_Esse_"+percentages[j],
                                            template=states_converter(
                                            path_in= workflow_dir+"03_distribution_data/",
                                            tip_states_file= workflow_dir+"03_distribution_data/"+families_shorter[i]+"_distribution_data_Esse.txt",
                    ...
                    for k in range(10):
                        gwf.target_from_template(name = families_shorter[i]+"_"+str(k)+"_Esse_G",
                                                template = Esse(
                                                tree_file = families_shorter[i]+"_Esse_tree.tre", # Input tree
                                                tip_states_file = workflow_dir+"03_distribution_data/"+families_shorter[i]+"_states_"+percentages[j]+"_Esse.txt", 
                                                paleo_clim_file = "NaN", # File with paleoclimatic variables
                                                done = families_shorter[i]+"_"+str(k)+"_Esse_G",
                                                path_in = workflow_dir+"02_adding_orders/pruning/subset_of_orders/",
                                                save_file = "Esse_output_G_"+families_shorter[i]+"_"+percentages[j]+"_"+str(k)+".jld2",
                                                script_dir=script_dir,
                                                done_dir = done_dir,
                                                out_states_file = "Esse_states_G_"+families_shorter[i]+"_"+percentages[j]+"_"+str(k), 
                                                hidden_states = 1,
                                                niter = 100000,
                                                out_file = "Esse_output_G_"+families_shorter[i]+"_hidden_states_"+percentages[j]+"_"+str(k),
                                                output_folder = workflow_dir+"04_results/Esse_output/",
                                                path_out = workflow_dir+"04_results/",
                                                biome_sampling = workflow_dir+"03_distribution_data/"+families_shorter[i]+"_biome_sampling_fraction.txt"
                                             ))    
...
for i in range(len(sub_family_clades)):
            gwf.target_from_template(name = sub_family_clades[i]+"_distribution_data_Esse",
                                ...
                                path_in =  workflow_dir+"02_adding_orders/pruning/subset_of_orders/",
                                path_out = workflow_dir+"03_distribution_data/",
                                output_file = sub_family_clades[i]+"_distribution_data_Esse.txt",
                                wcvp_file = workflow_dir+"02_adding_orders/wcvp_names_apg_aligned.rds",
            ...
            for j in range(len(percentages)):
                    gwf.target_from_template(name = sub_family_clades[i]+"_states_converter_Esse_"+percentages[j],
                                            template=states_converter(
                                            path_in= workflow_dir+"03_distribution_data/",
                                            tip_states_file= workflow_dir+"03_distribution_data/"+sub_family_clades[i]+"_distribution_data_Esse.txt",
                                            out_states_file= workflow_dir+"03_distribution_data/"+sub_family_clades[i]+"_states_"+percentages[j]+"_Esse.txt",
                                            script_dir= script_dir,
                                            done_dir= done_dir,
                    ...
                    gwf.target_from_template(name = sub_family_clades[i]+"_Sampling_fraction_Esse",
                                         template = sampling_frequency(
                                                ...
                                                path_in =  workflow_dir+"02_adding_orders/pruning/subset_of_orders/",
                                                path_out = workflow_dir+"03_distribution_data/",
                                                output_file = sub_family_clades[i]+"_sampling_fraction_Esse.txt",
                                                wcvp_file = workflow_dir+"02_adding_orders/wcvp_names_apg_aligned.rds",
                                                order = sub_family_clades[i],
                                                script_dir= script_dir,
                                                apg = script_dir+"apgweb_parsed.csv",
                    ...
                    for k in range(5):
                        gwf.target_from_template(name = sub_family_clades[i]+"_"+str(k)+"_Esse_GE",
                                                ...
                                                path_in = workflow_dir+"02_adding_orders/pruning/subset_of_orders/",
                                                save_file = "Esse_output_"+sub_family_clades[i]+"_"+percentages[j]+"_"+str(k)+".jld2",
                                                script_dir=script_dir,
                                                done_dir = done_dir,
                                                out_states_file = "Esse_states_"+sub_family_clades[i]+"_"+percentages[j]+"_"+str(k), 
                                                hidden_states = 1,
                                                niter = 200000,
                                                out_file = "Esse_output_"+sub_family_clades[i]+"_hidden_states_"+percentages[j]+"_"+str(k),
                                                output_folder = workflow_dir+"04_results/Esse_output/",
                                                path_out = workflow_dir+"04_results/",
                    ...
                    for k in range(5):
                        gwf.target_from_template(name = sub_family_clades[i]+"_"+str(k)+"_Esse_G",
                                                template = Esse(
                                                tree_file = sub_family_clades[i]+"_Esse_tree.tre", # Input tree
                                                tip_states_file = workflow_dir+"03_distribution_data/"+sub_family_clades[i]+"_states_"+percentages[j]+"_Esse.txt", 
                                                paleo_clim_file = "NaN", # File with paleoclimatic variables
                                                done = sub_family_clades[i]+"_"+str(k)+"_Esse_G",
                                                path_in = workflow_dir+"02_adding_orders/pruning/subset_of_orders/",
                                                save_file = "Esse_output_G_"+sub_family_clades[i]+"_"+percentages[j]+"_"+str(k)+".jld2",
                                                script_dir=script_dir,
                                                done_dir = done_dir,
                                                out_states_file = "Esse_states_G_"+sub_family_clades[i]+"_"+percentages[j]+"_"+str(k), 
                                                hidden_states = 1,
                                                niter = 200000,
                                                out_file = "Esse_output_G_"+sub_family_clades[i]+"_hidden_states_"+percentages[j]+"_"+str(k),
                                                output_folder = workflow_dir+"04_results/Esse_output/",
                                                path_out = workflow_dir+"04_results/",
                                                biome_sampling = workflow_dir+"03_distribution_data/"+sub_family_clades[i]+"_biome_sampling_fraction.txt"
                                             ))
...
#             #                     path_in =  workflow_dir+"02_adding_orders/pruning/subset_of_orders/",
#             #                     path_out = workflow_dir+"03_distribution_data/",
#             #                     output_file = sub_families_shorter[i]+"_distribution_data_Esse.txt",
#             #                     wcvp_file = workflow_dir+"02_adding_orders/wcvp_names_apg_aligned.rds",
...
#             #                                 template=states_converter(
#             #                                 path_in= workflow_dir+"03_distribution_data/",
#             #                                 tip_states_file= workflow_dir+"03_distribution_data/"+sub_families_shorter[i]+"_distribution_data_Esse.txt",
#             #                                 out_states_file= workflow_dir+"03_distribution_data/"+sub_families_shorter[i]+"_states_"+percentages[j]+"_Esse.txt",
#             #                                 script_dir= script_dir,
#             #                                 done_dir= done_dir,
...
#                                                 template = rem_tips(
#                                                 input_file_tree = "sub_phylo_"+sub_families_shorter[i]+".tre",
#                                                 distribution_file= workflow_dir+"03_distribution_data/"+sub_families_shorter[i]+"_states_"+percentages[j]+"_Esse.txt",
...
#                                                 tip_states_file = workflow_dir+"03_distribution_data/"+sub_families_shorter[i]+"_states_"+percentages[j]+"_Esse.txt", 
#                                                 paleo_clim_file = data_dir+"paleoclim_area.txt", # File with paleoclimatic variables
